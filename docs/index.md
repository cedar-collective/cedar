...
the college level, using the same documented methods. Analyses
developed at one institution can be adapted and shared rather than
each office solving the same problem independently.
