...
The Dept Dashboard gives a quick read on current-term course activity. Select a department and it loads automatically — no button, no wait for a full report. The goal is to make visible what is different this term, with enough historical context to decide what deserves a closer look.
...
{: .note }
This counts **students in your sections**, not declared majors. A student enrolled in three HIST courses counts once; a student who declared HIST but isn't taking any HIST courses this term doesn't appear here. For declared major headcount over time, see [Dept Trends](department-reports).
