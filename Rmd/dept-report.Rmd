...
knitr::opts_chunk$set(
  ...
  out.width = "100%",
  cache = FALSE,
  dev = "ragg_png",  # Faster image rendering
  dpi = 150
)
...
### College vs Department Direct Comparison
```{r college_dept_dual_plot} 
params$plots[["college_dept_dual_plot"]]
```


### Total Credit Hours
```{r chd_by_period_plot} 
params[["plots"]][["chd_by_period_plot"]]
...
### Credit Hours by Major - Lower Division Courses

::: {.row}
:::: {.col-md-6}
**Outside Majors (Lower Division)**
```{r sch_outside_pct_lower_plot, echo=FALSE}
params[["plots"]][["sch_outside_pct_lower_plot"]]
```
::::

:::: {.col-md-6}
**Majors vs Non-Majors (Lower Division)**
```{r sch_dept_pct_lower_plot, echo=FALSE}
params[["plots"]][["sch_dept_pct_lower_plot"]]
```
::::
:::
...
### Credit Hours by Major - Upper Division Courses

::: {.row}
:::: {.col-md-6}
**Outside Majors (Upper Division)**
```{r sch_outside_pct_upper_plot, echo=FALSE}
params[["plots"]][["sch_outside_pct_upper_plot"]]
```
::::

:::: {.col-md-6}
**Majors vs Non-Majors (Upper Division)**
```{r sch_dept_pct_upper_plot, echo=FALSE}
params[["plots"]][["sch_dept_pct_upper_plot"]]
```
::::
:::
...
color.me <- which(credit_hours_data_w$major %in% params$prog_codes)

if (nrow(credit_hours_data_w) > 0) {
  kbl(credit_hours_data_w, digits=2, table.attr = "class='table-responsive'") %>%   
    kable_styling(
      bootstrap_options = c("striped", "hover", "condensed", "responsive"),
      latex_options = c("striped", "HOLD_position", "condensed", "scale_down"), 
      position = "center", 
      full_width = TRUE,
      font_size = 12
    ) %>%
