...
summarize_student_demographics <- function(filtered_students, opt) {
  message("[course-demographics.R] Welcome to summarize_student_demographics!")
  ...
  if (is.null(group_cols)) {
    ...
    message("[course-demographics.R] Using provided group_cols.")
    group_cols <- convert_param_to_list(group_cols)
    group_cols <- as.character(group_cols)
  }

  message("[course-demographics.R] group_cols: ", paste(group_cols, collapse = ", "))
  ...
  message("[course-demographics.R] Returning student demographic summary with ", nrow(merge_sum_enrl), " rows...")
...
summarize_classifications <- function(filtered_students, opt) {
  warning("[course-demographics.R] summarize_classifications() is deprecated. Use summarize_student_demographics() instead.")
