...
- **`R/branches/`** — `population.R` (`build_population()`, the central cohort builder) · `comparison.R` (`build_comparison()`, `compute_balance()`) · `enrl.R` (`calc_cl_enrls()`, `get_enrl()`, census and history helpers) · `course-attempts.R` (`get_course_outcome_rates()`, `get_grade_distribution()`) · `data-edges.R` · `credit-timeline.R` · `gpa-timeline.R` · `course-flows.R` · `major-change-detection.R` · `retention-context.R` · `waitlist-demand.R` · `demographics.R` · `headcount.R` · `credit-hours.R` · `degrees.R` · `pathways.R`
